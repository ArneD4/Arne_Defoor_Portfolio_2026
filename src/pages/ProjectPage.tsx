...
export default function ProjectPage({ slug }: { slug: string }) {
  ...
  const tags = project?.tools?.length
    ? project.tools
    : [project?.category || ""];
  ...
  useGSAP(
    () => {
      ...
      tl.from(".eyebrow", {
        ...
        .from(
          ".project-card-tags .project-card-tag",
          {
            x: -20,
            opacity: 0,
            stagger: 0.06,
        ...
        .from(
          ".project-header-content-summary",
          {
            y: 20,
            opacity: 0,
          },
        ...
        .from(
          ...
          {
            // Smoothly stagger inside images
            opacity: 0,
            y: 30,
            stagger: 0.1,
          },
        ...
        <div className="project-header-content">
          <div className="project-header-content-top">
            ...
            {project.link && project.link !== "" && (
              <Link
                className="button button-tertiary project-header-content-button"
                to={project.link}
                target="_blank"
          ...
          <div className="related-projects-wrapper">
            ...
            <div className="related-projects">
              {relatedProjects.map((proj) => (
                <Link
                  key={proj.slug}
                  to={`?page=projects&slug=${proj.slug}`}
                  className="project-card related-project-card"
                >
                  <div className="project-card-image-wrapper">
                    ...
                    />
                    <img
                      className="project-card-image-hover"
                      src={proj.coverImage}
